...
Dataset: *The Great Gatsby by F. Scott Fitzgerald* (Project Gutenberg, public domain)
...
1. Download *The Great Gatsby by F. Scott Fitzgerald* (UTF-8) from Project Gutenberg  
   https://www.gutenberg.org/ebooks/64317

2. Save the file as: Gatsby.txt in the same directory as the script.

3. Install dependencies: pip install -r requirements.txt

4. Run: python Word2vec-Gatsby.py
