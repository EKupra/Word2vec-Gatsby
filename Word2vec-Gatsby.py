...
with open("Gatsby.txt", "r", encoding="latin-1") as f:
    text = f.read()
...
stopwords = {
    ...
    "me","my","we","us","our","him","them","their","your","yours","all","some"
}
...
most_similar("gatsby")
print()
most_similar_filtered("gatsby")
print("\n")

most_similar("daisy")
print()
most_similar_filtered("daisy")
print("\n")

most_similar("tom")
print()
most_similar_filtered("tom")